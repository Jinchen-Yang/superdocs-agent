...
export const mastra = new Mastra({
  ...
  server: {
    apiRoutes: [
      ...
      registerApiRoute('/app/ui', { method: 'GET', handler: async (c) => { try { c.header('Cache-Control', 'no-store'); return c.html(readFileSync(NEXT_DIR + '/index.html', 'utf8')); } catch { return c.text('UI not built', 404); } } }),
